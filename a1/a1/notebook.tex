...
{\color{incolor}In [{\color{incolor}25}]:} \PY{c+c1}{\PYZsh{} \PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}\PYZhy{}}
         ...
         \PY{n}{pprint}\PY{o}{.}\PY{n}{pprint}\PY{p}{(}\PY{n}{wv\PYZus{}from\PYZus{}bin}\PY{o}{.}\PY{n}{most\PYZus{}similar}\PY{p}{(}\PY{n}{positive}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{white}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{king}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{n}{negative}\PY{o}{=}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{black}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
[('kings', 0.6006536483764648),
 ('queen', 0.5555342435836792),
 ('monarch', 0.5463213324546814),
 ('prince', 0.5353781580924988),
 ('crown\_prince', 0.5255115628242493),
 ('sultan', 0.5160589218139648),
 ('Simeon\_Saxcoburggotski', 0.4914967119693756),
 ('Savory\_aromas\_wafted', 0.47686171531677246),
 ('princess', 0.47112494707107544),
 ('princes', 0.4690479040145874)]
...
\tightlist
\item
  6 references to male gender \{kings, monarch, prince, crown\_prince,
  sultan, princes\}
\item
  2 references to female gender \{queen, princess\}
\end{itemize}
